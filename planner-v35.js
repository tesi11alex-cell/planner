(() => {
  ...
  */
  ...
  function forceCompactNotes(){
    ...
    notes.classList.remove('v35-notes-expanded');
    document.body.classList.remove('v35-notes-expanded-active');
  ...
  function forceCompactDays(){
    ...
    document.body.classList.remove('v35-expanded-active');
  }
...
function ensureStandardButton(){
    /* V35: il pulsante non viene più mostrato nella sidebar. */
  }

  function ensureInsideStandardButton(card){
    if(!card) return;

    let row = card.querySelector('.v35-standard-row');
    if(row) return;
    ...
    row.className = 'v35-standard-row';

    const button = document.createElement('button');
    button.type = 'button';
    button.className = 'v35-standard-inside';
  ...
  function ensureNotesActions(){
    ...
    if(head.querySelector('.v35-notes-actions')) return;

    const actions = document.createElement('div');
    actions.className = 'v35-notes-actions';

    const standardButton = document.createElement('button');
    standardButton.type = 'button';
    standardButton.className = 'v35-notes-standard';
  ...
  function updateCompactNotesSpan(){
    ...
    notes.classList.remove('v35-notes-one-col');
    ...
    */
    ...
    if(col === 2){
      notes.classList.add('v35-notes-one-col');
    }
  }
...
function applyNotesLayout(){
    ...
    */
    ...
    document.body.classList.add('v35-notes-expanded-active');
    document.body.classList.remove('v35-expanded-active');
    notes.classList.remove('v35-notes-one-col');
    notes.classList.add('v35-notes-expanded');
  ...
  function clearExpansion(card){
    card.classList.remove('v35-expanded');
  ...
  function applyExpandedLayout(){
    ...
    document.body.classList.add('v35-expanded-active');
    selected.classList.add('v35-expanded');
