(() => {
  ...
  */
  ...
  function forceCompactNotes(){
    ...
    notes.classList.remove('v36-notes-expanded');
    document.body.classList.remove('v36-notes-expanded-active');
  ...
  function forceCompactDays(){
    ...
    document.body.classList.remove('v36-expanded-active');
  }
...
function ensureStandardButton(){
    /* V36: il pulsante non viene più mostrato nella sidebar. */
  }
  ...
  function ensureLargeDayButton(card){
    ...
    if(!head || head.querySelector('.v36-large-day')) return;

    const button = document.createElement('button');
    button.type = 'button';
    button.className = 'v36-large-day';
...
function ensureInsideStandardButton(card){
    ...
    let row = card.querySelector('.v36-standard-row');
    if(row) return;
    ...
    row.className = 'v36-standard-row';

    const button = document.createElement('button');
    button.type = 'button';
    button.className = 'v36-standard-inside';
  ...
  function ensureNotesActions(){
    ...
    if(head.querySelector('.v36-notes-actions')) return;

    const actions = document.createElement('div');
    actions.className = 'v36-notes-actions';

    const largeButton = document.createElement('button');
    largeButton.type = 'button';
    largeButton.className = 'v36-notes-large';
    ...
    standardButton.className = 'v36-notes-standard';
  ...
  function updateCompactNotesSpan(){
    ...
    notes.classList.remove('v36-notes-one-col');
    ...
    */
    ...
    if(col === 2){
      notes.classList.add('v36-notes-one-col');
    }
  }
...
function applyNotesLayout(){
    ...
    */
    ...
    document.body.classList.add('v36-notes-expanded-active');
    document.body.classList.remove('v36-expanded-active');
    notes.classList.remove('v36-notes-one-col');
    notes.classList.add('v36-notes-expanded');
  ...
  function clearExpansion(card){
    card.classList.remove('v36-expanded');
  ...
  function applyExpandedLayout(){
    ...
    document.body.classList.add('v36-expanded-active');
    selected.classList.add('v36-expanded');
