  ...
  */
  function applyCompactHoursToCard(card){
    ...
    card.querySelectorAll('.hour-row[data-base-hour]').forEach(row => {
      ...
      const keepBoundary = baseHour === '08:00' || baseHour === '22:00';
  ...
  function ensureStandardButton(){
    ...
    if(!sidebar || document.getElementById('standardViewBtnV26')) return;

    const button = document.createElement('button');
    button.id = 'standardViewBtnV26';
    button.type = 'button';
    button.className = 'standard-view-btn-v26';
    button.textContent = '↺ Vista standard';
    button.title = 'Torna alla vista compatta';
    ...
    button.addEventListener('click', () => {
      ...
      document.body.classList.remove('v26-expanded-active');
      applyExpandedLayout();
      applyCompactHours();
  ...
  function clearExpansion(card){
    card.classList.remove('v26-expanded');
  ...
  function applyExpandedLayout(){
    ...
    const button = document.getElementById('standardViewBtnV26');
    ...
    document.body.classList.add('v26-expanded-active');
    selected.classList.add('v26-expanded');
