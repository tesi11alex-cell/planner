(() => {
  ...
  */
  ...
  function forceCompactNotes(){
    ...
    notes.classList.remove('v34-notes-expanded');
    document.body.classList.remove('v34-notes-expanded-active');
  ...
  function forceCompactDays(){
    ...
    document.body.classList.remove('v34-expanded-active');
  }
...
function ensureStandardButton(){
    /* V34: il pulsante non viene più mostrato nella sidebar. */
  }

  function ensureInsideStandardButton(card){
    if(!card) return;

    let row = card.querySelector('.v34-standard-row');
    if(row) return;
    ...
    row.className = 'v34-standard-row';

    const button = document.createElement('button');
    button.type = 'button';
    button.className = 'v34-standard-inside';
  ...
  function ensureNotesActions(){
    ...
    if(head.querySelector('.v34-notes-actions')) return;

    const actions = document.createElement('div');
    actions.className = 'v34-notes-actions';

    const standardButton = document.createElement('button');
    standardButton.type = 'button';
    standardButton.className = 'v34-notes-standard';
  ...
  function updateCompactNotesSpan(){
    ...
    notes.classList.remove('v34-notes-one-col');
    ...
    */
    ...
    if(col === 2){
      notes.classList.add('v34-notes-one-col');
    }
  }
...
function applyNotesLayout(){
    ...
    */
    ...
    document.body.classList.add('v34-notes-expanded-active');
    document.body.classList.remove('v34-expanded-active');
    notes.classList.remove('v34-notes-one-col');
    notes.classList.add('v34-notes-expanded');
  ...
  function clearExpansion(card){
    card.classList.remove('v34-expanded');
  ...
  function applyExpandedLayout(){
    ...
    document.body.classList.add('v34-expanded-active');
    selected.classList.add('v34-expanded');
