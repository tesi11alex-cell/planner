(() => {
  ...
  */
  ...
  function forceCompactNotes(){
    ...
    notes.classList.remove('v38-notes-expanded');
    document.body.classList.remove('v38-notes-expanded-active');
  ...
  function forceCompactDays(){
    ...
    document.body.classList.remove('v38-expanded-active');
  }
...
function ensureStandardButton(){
    /* V38: il pulsante non viene più mostrato nella sidebar. */
  }
  ...
  function ensureLargeDayButton(card){
    ...
    if(!head || head.querySelector('.v38-large-day')) return;

    const button = document.createElement('button');
    button.type = 'button';
    button.className = 'v38-large-day';
...
function ensureInsideStandardButton(card){
    ...
    let row = card.querySelector('.v38-standard-row');
    if(row) return;
    ...
    row.className = 'v38-standard-row';

    const button = document.createElement('button');
    button.type = 'button';
    button.className = 'v38-standard-inside';
  ...
  function ensureNotesActions(){
    ...
    if(head.querySelector('.v38-notes-actions')) return;

    const actions = document.createElement('div');
    actions.className = 'v38-notes-actions';

    const largeButton = document.createElement('button');
    largeButton.type = 'button';
    largeButton.className = 'v38-notes-large';
    ...
    standardButton.className = 'v38-notes-standard';
  ...
  function updateCompactNotesSpan(){
    ...
    notes.classList.remove('v38-notes-one-col');
    ...
    */
    ...
    if(col === 2){
      notes.classList.add('v38-notes-one-col');
    }
  }
...
function applyNotesLayout(){
    ...
    */
    ...
    document.body.classList.add('v38-notes-expanded-active');
    document.body.classList.remove('v38-expanded-active');
    notes.classList.remove('v38-notes-one-col');
    notes.classList.add('v38-notes-expanded');
  ...
  function clearExpansion(card){
    card.classList.remove('v38-expanded');
  ...
  function applyExpandedLayout(){
    ...
    document.body.classList.add('v38-expanded-active');
    selected.classList.add('v38-expanded');
