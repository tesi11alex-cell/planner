(() => {
  ...
  */
  ...
  function forceCompactNotes(){
    ...
    notes.classList.remove('v33-notes-expanded');
    document.body.classList.remove('v33-notes-expanded-active');
  ...
  function forceCompactDays(){
    ...
    document.body.classList.remove('v33-expanded-active');
  }
...
function ensureStandardButton(){
    /* V33: il pulsante non viene più mostrato nella sidebar. */
  }

  function ensureInsideStandardButton(card){
    if(!card) return;

    let row = card.querySelector('.v33-standard-row');
    if(row) return;
    ...
    row.className = 'v33-standard-row';

    const button = document.createElement('button');
    button.type = 'button';
    button.className = 'v33-standard-inside';
  ...
  function ensureNotesActions(){
    ...
    if(head.querySelector('.v33-notes-actions')) return;

    const actions = document.createElement('div');
    actions.className = 'v33-notes-actions';

    const standardButton = document.createElement('button');
    standardButton.type = 'button';
    standardButton.className = 'v33-notes-standard';
  ...
  function applyNotesLayout(){
    ...
    */
    ...
    document.body.classList.add('v33-notes-expanded-active');
    document.body.classList.remove('v33-expanded-active');
    notes.classList.add('v33-notes-expanded');
  ...
  function clearExpansion(card){
    card.classList.remove('v33-expanded');
  ...
  function applyExpandedLayout(){
    ...
    document.body.classList.add('v33-expanded-active');
    selected.classList.add('v33-expanded');
